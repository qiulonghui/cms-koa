...
class UpdateOrderRepairStateValidator extends LinValidator {
  constructor () {
    super();
    this.state = new Rule('isNotEmpty', '必须传入工单状态');
  }
}

export { CreateOrUpdateOrderRepairValidator, OrderRepairSearchValidator, UpdateOrderRepairStateValidator };
